...
function App () {
  ...
  useEffect(() => {
    ...
    setTasks(filtered)
    // `user` entra en las dependencias para recargar las tareas al cambiar de sesión.
  ...
  return (
    <>
      ...
      <footer className='mt-auto text-white/50'>
        <div className='flex justify-center items-center gap-3 mt-3 leading-5'>
          <span>Diseñado y desarrollado por José L. Beltre C.</span>
